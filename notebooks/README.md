This directory contains Jupyter notebooks for various features.
...
The CPA attack was not done in a notebook setup (currently). Instead it was done with manual Python traces. This is described in the `attack_scripts` folder of the repo.
